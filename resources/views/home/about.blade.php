  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="/"><h2>T<em>extile</em></h2></a>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-image">
              <img src="../../img/bg-1.jpg" width="1000" height="600">
            </div>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="home/images/team-01.jpg" alt="">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="home/images/team-02.jpg" alt="">
              <div class="down-content">
                <h4>......</h4>
                <span>Co-Founder</span>
              </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="home/images/team-03.jpg" alt="">
              <div class="down-content">
                <h4>......</h4>
                <span>Co-Founder</span>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="sub-footer">
              <p>Copyright &copy; 2022 <a rel="nofollow" href="https://templatemo.com">TemplateMo</a></p>
            </div>
          </div>
        </div>
      </div>

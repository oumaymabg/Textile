			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(img/bg-2.jpg);">
			      </div>
                    ...
                    <div class="form-group mb-3">
		            	<label class="label" for="password">Company Name</label>
		              <input type="password" class="form-control" placeholder="Company Name" required>
		            </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
		              ...
		              <input type="password" class="form-control" placeholder="Country" required>
		            </div>
                    <div class="form-group mb-3">
		          ...
		          <p class="text-center"> You are a member? <a data-toggle="tab" href="/Login">Sign In</a></p>
		        </div>
		      </div>
				</div>
			</div>

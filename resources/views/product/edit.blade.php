...
<input type="text" class="form-control" name="ProductName" placeholder="product name" value="{{$product->product_name}}">
...
<input name="type" placeholder="Type" class="form-control"  type="text" value="{{$product->type}}">
</div>
</div>
</div>
...
<input name="price" placeholder="TND" class="form-control" type="text" value="{{$product->price}}">
</div>
</div>
</div>
